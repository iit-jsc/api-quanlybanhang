...
CREATE TABLE `Permission` (
    ...
    INDEX `Permission_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `EmployeeGroup` (
    ...
    INDEX `EmployeeGroup_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `PrintTemplate` (
    ...
    INDEX `PrintTemplate_shopId_idx`(`shopId`),
...
CREATE TABLE `CurrencyUnit` (
    ...
    INDEX `CurrencyUnit_branchId_idx`(`branchId`),
...
CREATE TABLE `MeasurementUnit` (
    ...
    INDEX `MeasurementUnit_branchId_idx`(`branchId`),
...
CREATE TABLE `ActivityLog` (
    ...
    INDEX `ActivityLog_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ProductType` (
    ...
    INDEX `ProductType_branchId_idx`(`branchId`),
...
CREATE TABLE `OtherAttributePattern` (
    ...
    INDEX `OtherAttributePattern_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ProductOption` (
    ...
    INDEX `ProductOption_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ProductOptionGroup` (
    ...
    INDEX `ProductOptionGroup_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `CustomerType` (
    ...
    INDEX `CustomerType_shopId_idx`(`shopId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `SupplierType` (
    ...
    INDEX `SupplierType_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Supplier` (
    ...
    INDEX `Supplier_branchId_idx`(`branchId`),
...
CREATE TABLE `Promotion` (
    ...
    `amount` INTEGER NOT NULL,
    `amountApplied` INTEGER NULL DEFAULT 0,
...
CREATE TABLE `PromotionCondition` (
    ...
    INDEX `PromotionCondition_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `PromotionProduct` (
    ...
    INDEX `PromotionProduct_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `OrderDetail` (
    ...
    INDEX `OrderDetail_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `TableTransaction` (
    ...
    INDEX `TableTransaction_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `DiscountIssue` (
    ...
    INDEX `DiscountIssue_branchId_idx`(`branchId`),
...
CREATE TABLE `DiscountCode` (
    ...
    INDEX `DiscountCode_branchId_idx`(`branchId`),
...
CREATE TABLE `PointSetting` (
    ...
    INDEX `PointSetting_shopId_idx`(`shopId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `PointAccumulation` (
    ...
    INDEX `PointAccumulation_shopId_idx`(`shopId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `PointHistory` (
    ...
    INDEX `PointHistory_shopId_idx`(`shopId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `CustomerRequest` (
    ...
    INDEX `CustomerRequest_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `OrderRating` (
    ...
    INDEX `OrderRating_orderId_idx`(`orderId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Branch` (
    ...
    INDEX `Branch_shopId_idx`(`shopId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `WorkShift` (
    ...
    INDEX `WorkShift_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `EmployeeSchedule` (
    ...
    INDEX `EmployeeSchedule_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `TableSalary` (
    ...
    INDEX `TableSalary_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `DetailTableSalary` (
    ...
    INDEX `DetailTableSalary_branchId_idx`(`branchId`),
...
CREATE TABLE `CompensationSetting` (
    ...
    INDEX `CompensationSetting_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `CompensationEmployee` (
    ...
    INDEX `CompensationEmployee_branchId_idx`(`branchId`),
...
CREATE TABLE `EmployeeSalary` (
    ...
    INDEX `EmployeeSalary_branchId_idx`(`branchId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `QRSetting` (
    ...
    INDEX `QRSetting_shopId_idx`(`shopId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `FeatureUsageSetting` (
    ...
    INDEX `FeatureUsageSetting_shopId_idx`(`shopId`),
...
CREATE TABLE `AccountSocket` (
    ...
    INDEX `AccountSocket_shopId_idx`(`shopId`),
    INDEX `AccountSocket_branchId_idx`(`branchId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `PaymentMethod` (
    ...
    INDEX `PaymentMethod_branchId_idx`(`branchId`),
...
-- AddForeignKey
ALTER TABLE `CustomerRequest` ADD CONSTRAINT `CustomerRequest_updatedBy_fkey` FOREIGN KEY (`updatedBy`) REFERENCES `Account`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `CustomerRequest` ADD CONSTRAINT `CustomerRequest_tableId_fkey` FOREIGN KEY (`tableId`) REFERENCES `Table`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
