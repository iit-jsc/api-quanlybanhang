...
export class EmployeeSalaryService {
  ...
  //   isFulltime: boolean,
  //   data: CreateCompensationEmployeeDto,
  ...
  //           {
  //             applyTo: isFulltime
  //               ? COMPENSATION_APPLY_TO.FULLTIME
  //               : COMPENSATION_APPLY_TO.PART_TIME
  //           }
  //         ]
  //       },
  ...
  //   const compensationSettingData = compensationSettings.map(
  ...
  //     return prisma.compensationEmployee.createMany({
  //       data: compensationSettingData
  //     })
  //   })
  // }
