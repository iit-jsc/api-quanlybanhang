...
export class EmployeeScheduleService {
  ...
  //   const workShift = await this.getAndCheckLimitWorkShift(
  //     data.workShiftId,
  //     where.id
  //   )

  //   const validIds = await this.filterValidRegisterSchedule(
  //     [where.id],
  //     tokenPayload
  //   )
  ...
  //       HttpStatus.CONFLICT,
  //       'Không thể cập nhật dữ liệu này!'
  //     )
  ...
  // async findAll(
  //   params: FindManyEmployeeScheduleDto,
  //   tokenPayload: TokenPayload
  // ) {
  //   let {
  //     page,
  ...
  //   return isStaff
  //     ? { ...count, ids: validIds, notValidIds }
  //     : { ...count, ids: data.ids }
  // }

  // async filterValidRegisterSchedule(
  //   employeeScheduleIds: string[],
  //   tokenPayload: TokenPayload
  // ) {
  ...
  // async getAndCheckLimitWorkShift(
  //   workShiftId: string,
  ...
  //   if (
  //     !workShift.isNotLimitEmployee &&
  //     countEmployee >= workShift.limitEmployee
  //   )
  //     throw new CustomHttpException(
  //       HttpStatus.CONFLICT,
