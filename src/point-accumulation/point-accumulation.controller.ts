...
export class PointAccumulationController {
  constructor(private readonly pointAccumulationService: PointAccumulationService) {}
  ...
  getPointByShop(@Param("customerId") customerId: string, @Req() req: any) {
    ...
    return this.pointAccumulationService.getPointByShop({ customerId }, tokenPayload);
  }
}
