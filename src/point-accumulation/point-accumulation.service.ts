...
export class PointAccumulationService {
  ...
  // async getPointByShop(
  //   where: Prisma.PointAccumulationWhereUniqueInput,
  ...
  //   if (exchangePoint) {
  //     // Quy đổi số tiền
  //     const convertedPointValue =
  //       (exchangePoint * pointSetting.value) / pointSetting.point
  ...
  //     if (
  //       !currentPoint ||
  //       currentPoint.point < exchangePoint ||
  //       convertedPointValue > totalInOrder
  //     )
  //       throw new CustomHttpException(
  //         HttpStatus.CONFLICT,
  //         'Điểm đổi không hợp lệ!'
  //       )

  //     await this.handleExchangePoint(
  //       customerId,
  //       orderId,
  //       exchangePoint,
  //       shopId,
  ...
  //   //  Xử lý cộng điểm
  //   const point =
  //     Math.floor((totalInOrder * pointSetting.point) / pointSetting.value) || 0

  //   await this.handleAddPoint(customerId, orderId, point, shopId, prisma)
  // }

  // async checkValidExchangePoint(
  //   customerId: string,
  //   exchangePoint: number,
  //   totalInOrder: number,
  //   shopId: string
