...
export class ToppingController {
  ...
  @HttpCode(HttpStatus.OK)
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles("CREATE_TOPPING", "UPDATE_TOPPING", "DELETE_TOPPING", "VIEW_TOPPING", SPECIAL_ROLE.MANAGER)
  ...
  update(@Param("id") id: string, @Body() updateToppingDto: UpdateToppingDto, @Req() req: any) {
    const tokenPayload = req.tokenPayload as TokenPayload;
